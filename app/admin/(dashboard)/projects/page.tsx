...
export default async function AdminProjectsPage() {
  ...
  return <main className="p-6 sm:p-8 lg:p-10"><div className="mx-auto max-w-6xl"><div className="flex flex-col gap-5 border-b border-white/10 pb-8 sm:flex-row sm:items-end sm:justify-between"><div><p className="eyebrow">Content</p><h1 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">Projects</h1><p className="mt-3 text-slate-400">Manage the work displayed across your portfolio.</p></div><button type="button" disabled title="Project creation is coming next" className="button-primary cursor-not-allowed justify-center opacity-50"><Plus size={17}/>New project <span className="font-mono text-[9px] uppercase tracking-wider">Coming next</span></button></div>
